...
public partial class Artist
{
    ...
    public static Artist Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out Artist obj, out Exception exception)
    {
        exception = null;
        obj = default(Artist);
        try
    ...
    public static bool LoadFromFile(string fileName, out Artist obj, out Exception exception)
    {
