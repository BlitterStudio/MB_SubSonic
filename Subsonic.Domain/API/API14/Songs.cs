...
public partial class Songs
{
    ...
    public static bool Deserialize(string input, out Songs obj, out Exception exception)
    {
        exception = null;
        obj = default(Songs);
        try
    ...
    public static Songs Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out Songs obj, out Exception exception)
    {
        exception = null;
        obj = default(Songs);
        try
    ...
    public static bool LoadFromFile(string fileName, out Songs obj, out Exception exception)
    {
