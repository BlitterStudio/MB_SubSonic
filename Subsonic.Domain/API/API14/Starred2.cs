...
public partial class Starred2
{
    ...
    public static Starred2 Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out Starred2 obj, out Exception exception)
    {
        exception = null;
        obj = default(Starred2);
        try
    ...
    public static bool LoadFromFile(string fileName, out Starred2 obj, out Exception exception)
    {
