...
public partial class SimilarSongs
{
    ...
    public static bool Deserialize(string input, out SimilarSongs obj, out Exception exception)
    {
        exception = null;
    ...
    public static SimilarSongs Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out SimilarSongs obj, out Exception exception)
    {
        exception = null;
        obj = default(SimilarSongs);
        try
    ...
    public static bool LoadFromFile(string fileName, out SimilarSongs obj, out Exception exception)
    {
