...
public partial class AlbumList
{
    ...
    public static AlbumList Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out AlbumList obj, out Exception exception)
    {
        exception = null;
        obj = default(AlbumList);
        try
    ...
    public static bool LoadFromFile(string fileName, out AlbumList obj, out Exception exception)
    {
