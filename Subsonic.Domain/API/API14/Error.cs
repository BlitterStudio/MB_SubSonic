...
public partial class Error
{
    ...
    public static bool Deserialize(string input, out Error obj, out Exception exception)
    {
        exception = null;
        obj = default(Error);
        try
    ...
    public static Error Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out Error obj, out Exception exception)
    {
        exception = null;
        obj = default(Error);
        try
    ...
    public static bool LoadFromFile(string fileName, out Error obj, out Exception exception)
    {
