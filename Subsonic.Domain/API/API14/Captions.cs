...
public partial class Captions
{
    ...
    public static bool Deserialize(string input, out Captions obj, out Exception exception)
    {
        exception = null;
    ...
    public static Captions Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out Captions obj, out Exception exception)
    {
        exception = null;
        obj = default(Captions);
        try
    ...
    public static bool LoadFromFile(string fileName, out Captions obj, out Exception exception)
    {
