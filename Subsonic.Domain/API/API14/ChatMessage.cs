...
public partial class ChatMessage
{
    ...
    public static bool Deserialize(string input, out ChatMessage obj, out Exception exception)
    {
        exception = null;
    ...
    public static ChatMessage Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out ChatMessage obj, out Exception exception)
    {
        exception = null;
        obj = default(ChatMessage);
        try
    ...
    public static bool LoadFromFile(string fileName, out ChatMessage obj, out Exception exception)
    {
