...
public partial class Indexes
{
    ...
    public static bool Deserialize(string input, out Indexes obj, out Exception exception)
    {
        exception = null;
        obj = default(Indexes);
        try
    ...
    public static Indexes Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out Indexes obj, out Exception exception)
    {
        exception = null;
        obj = default(Indexes);
        try
    ...
    public static bool LoadFromFile(string fileName, out Indexes obj, out Exception exception)
    {
