...
public partial class AudioTrack
{
    ...
    public static AudioTrack Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out AudioTrack obj, out Exception exception)
    {
        exception = null;
        obj = default(AudioTrack);
        try
    ...
    public static bool LoadFromFile(string fileName, out AudioTrack obj, out Exception exception)
    {
