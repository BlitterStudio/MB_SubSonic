...
public partial class Users
{
    ...
    public static bool Deserialize(string input, out Users obj, out Exception exception)
    {
        exception = null;
        obj = default(Users);
        try
    ...
    public static Users Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out Users obj, out Exception exception)
    {
        exception = null;
        obj = default(Users);
        try
