...
public partial class TopSongs
{
    ...
    public static TopSongs Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out TopSongs obj, out Exception exception)
    {
        exception = null;
        obj = default(TopSongs);
        try
    ...
    public static bool LoadFromFile(string fileName, out TopSongs obj, out Exception exception)
    {
