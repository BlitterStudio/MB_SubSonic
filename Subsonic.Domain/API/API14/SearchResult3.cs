...
public partial class SearchResult3
{
    ...
    public static bool Deserialize(string input, out SearchResult3 obj, out Exception exception)
    {
        exception = null;
    ...
    public static SearchResult3 Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out SearchResult3 obj, out Exception exception)
    {
        exception = null;
        obj = default(SearchResult3);
        try
    ...
    public static bool LoadFromFile(string fileName, out SearchResult3 obj, out Exception exception)
    {
