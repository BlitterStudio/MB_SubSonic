...
public partial class PlayQueue
{
    ...
    public static PlayQueue Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out PlayQueue obj, out Exception exception)
    {
        exception = null;
        obj = default(PlayQueue);
        try
    ...
    public static bool LoadFromFile(string fileName, out PlayQueue obj, out Exception exception)
    {
