...
public partial class Share
{
    ...
    public static bool Deserialize(string input, out Share obj, out Exception exception)
    {
        exception = null;
        obj = default(Share);
        try
    ...
    public static Share Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out Share obj, out Exception exception)
    {
        exception = null;
        obj = default(Share);
        try
    ...
    public static bool LoadFromFile(string fileName, out Share obj, out Exception exception)
    {
