...
public partial class Podcasts
{
    ...
    public static bool Deserialize(string input, out Podcasts obj, out Exception exception)
    {
        exception = null;
    ...
    public static Podcasts Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out Podcasts obj, out Exception exception)
    {
        exception = null;
        obj = default(Podcasts);
        try
    ...
    public static bool LoadFromFile(string fileName, out Podcasts obj, out Exception exception)
    {
