...
public partial class SearchResult
{
    ...
    public static bool Deserialize(string input, out SearchResult obj, out Exception exception)
    {
        exception = null;
    ...
    public static SearchResult Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out SearchResult obj, out Exception exception)
    {
        exception = null;
        obj = default(SearchResult);
        try
    ...
    public static bool LoadFromFile(string fileName, out SearchResult obj, out Exception exception)
    {
