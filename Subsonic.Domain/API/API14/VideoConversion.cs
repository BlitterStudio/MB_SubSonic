...
public partial class VideoConversion
{
    ...
    public static bool Deserialize(string input, out VideoConversion obj, out Exception exception)
    {
        exception = null;
    ...
    public static VideoConversion Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out VideoConversion obj, out Exception exception)
    {
        exception = null;
        obj = default(VideoConversion);
        try
    ...
    public static bool LoadFromFile(string fileName, out VideoConversion obj, out Exception exception)
    {
