...
public partial class AlbumInfo
{
    ...
    public static bool Deserialize(string input, out AlbumInfo obj, out Exception exception)
    {
        exception = null;
    ...
    public static AlbumInfo Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out AlbumInfo obj, out Exception exception)
    {
        exception = null;
        obj = default(AlbumInfo);
        try
    ...
    public static bool LoadFromFile(string fileName, out AlbumInfo obj, out Exception exception)
    {
