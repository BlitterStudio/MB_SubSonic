...
public partial class Playlists
{
    ...
    public static bool Deserialize(string input, out Playlists obj, out Exception exception)
    {
        exception = null;
    ...
    public static Playlists Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out Playlists obj, out Exception exception)
    {
        exception = null;
        obj = default(Playlists);
        try
    ...
    public static bool LoadFromFile(string fileName, out Playlists obj, out Exception exception)
    {
