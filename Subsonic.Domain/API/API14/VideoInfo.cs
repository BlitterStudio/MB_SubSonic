...
public partial class VideoInfo
{
    ...
    private static XmlSerializer serializer;
        ...
        public List<VideoConversion> Conversion { get; set; }
        public string Id { get; set; }
    
    public VideoInfo()
    {
        Conversion = new List<VideoConversion>();
        AudioTrack = new List<AudioTrack>();
        Captions = new List<Captions>();
    }
    ...
    public static bool Deserialize(string input, out VideoInfo obj, out Exception exception)
    {
        exception = null;
    ...
    public static VideoInfo Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out VideoInfo obj, out Exception exception)
    {
        exception = null;
        obj = default(VideoInfo);
        try
    ...
    public static bool LoadFromFile(string fileName, out VideoInfo obj, out Exception exception)
    {
