...
public partial class AlbumID3
{
    ...
    public static bool Deserialize(string input, out AlbumID3 obj, out Exception exception)
    {
        exception = null;
    ...
    public static AlbumID3 Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out AlbumID3 obj, out Exception exception)
    {
        exception = null;
        obj = default(AlbumID3);
        try
    ...
    public static bool LoadFromFile(string fileName, out AlbumID3 obj, out Exception exception)
    {
