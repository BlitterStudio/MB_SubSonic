...
public partial class ArtistInfoBase
{
    ...
    public static ArtistInfoBase Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out ArtistInfoBase obj, out Exception exception)
    {
        exception = null;
        obj = default(ArtistInfoBase);
        try
    ...
    public static bool LoadFromFile(string fileName, out ArtistInfoBase obj, out Exception exception)
    {
