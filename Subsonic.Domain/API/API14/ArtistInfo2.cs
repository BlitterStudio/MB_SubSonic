...
public partial class ArtistInfo2 : ArtistInfoBase
{
    ...
    public static ArtistInfo2 Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out ArtistInfo2 obj, out Exception exception)
    {
        exception = null;
        obj = default(ArtistInfo2);
        try
    ...
    public static bool LoadFromFile(string fileName, out ArtistInfo2 obj, out Exception exception)
    {
