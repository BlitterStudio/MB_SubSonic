...
public partial class Videos
{
    ...
    public static Videos Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out Videos obj, out Exception exception)
    {
        exception = null;
        obj = default(Videos);
        try
    ...
    public static bool LoadFromFile(string fileName, out Videos obj, out Exception exception)
    {
