...
public partial class InternetRadioStations
{
    ...
    public static bool Deserialize(string input, out InternetRadioStations obj, out Exception exception)
    {
        exception = null;
    ...
    public static InternetRadioStations Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out InternetRadioStations obj, out Exception exception)
    {
        exception = null;
        obj = default(InternetRadioStations);
        try
    ...
    public static bool LoadFromFile(string fileName, out InternetRadioStations obj, out Exception exception)
    {
