...
public partial class ArtistWithAlbumsID3 : ArtistID3
{
    ...
    public static ArtistWithAlbumsID3 Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out ArtistWithAlbumsID3 obj, out Exception exception)
    {
        exception = null;
        obj = default(ArtistWithAlbumsID3);
        try
    ...
    public static bool LoadFromFile(string fileName, out ArtistWithAlbumsID3 obj, out Exception exception)
    {
