...
public partial class NewestPodcasts
{
    ...
    public static bool Deserialize(string input, out NewestPodcasts obj, out Exception exception)
    {
        exception = null;
    ...
    public static NewestPodcasts Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out NewestPodcasts obj, out Exception exception)
    {
        exception = null;
        obj = default(NewestPodcasts);
        try
    ...
    public static bool LoadFromFile(string fileName, out NewestPodcasts obj, out Exception exception)
    {
