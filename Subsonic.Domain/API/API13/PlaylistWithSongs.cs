...
public partial class PlaylistWithSongs : Playlist
{
    ...
    public static PlaylistWithSongs Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out PlaylistWithSongs obj, out Exception exception)
    {
        exception = null;
        obj = default(PlaylistWithSongs);
        try
    ...
    public static bool LoadFromFile(string fileName, out PlaylistWithSongs obj, out Exception exception)
    {
