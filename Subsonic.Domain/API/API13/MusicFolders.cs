...
public partial class MusicFolders
{
    ...
    public static bool Deserialize(string input, out MusicFolders obj, out Exception exception)
    {
        exception = null;
    ...
    public static MusicFolders Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out MusicFolders obj, out Exception exception)
    {
        exception = null;
        obj = default(MusicFolders);
        try
    ...
    public static bool LoadFromFile(string fileName, out MusicFolders obj, out Exception exception)
    {
