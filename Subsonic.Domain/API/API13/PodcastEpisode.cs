...
public partial class PodcastEpisode : Child
{
    ...
    public static bool Deserialize(string input, out PodcastEpisode obj, out Exception exception)
    {
        exception = null;
    ...
    public static PodcastEpisode Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out PodcastEpisode obj, out Exception exception)
    {
        exception = null;
        obj = default(PodcastEpisode);
        try
    ...
    public static bool LoadFromFile(string fileName, out PodcastEpisode obj, out Exception exception)
    {
