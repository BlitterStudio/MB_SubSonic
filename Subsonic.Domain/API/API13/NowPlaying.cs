...
public partial class NowPlaying
{
    ...
    public NowPlaying()
    {
        Entry = new List<NowPlayingEntry>();
    }
    ...
    public static bool Deserialize(string input, out NowPlaying obj, out Exception exception)
    {
        exception = null;
    ...
    public static NowPlaying Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out NowPlaying obj, out Exception exception)
    {
        exception = null;
        obj = default(NowPlaying);
        try
    ...
    public static bool LoadFromFile(string fileName, out NowPlaying obj, out Exception exception)
    {
