...
public partial class Starred
{
    ...
    public static bool Deserialize(string input, out Starred obj, out Exception exception)
    {
        exception = null;
        obj = default(Starred);
        try
    ...
    public static Starred Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out Starred obj, out Exception exception)
    {
        exception = null;
        obj = default(Starred);
        try
    ...
    public static bool LoadFromFile(string fileName, out Starred obj, out Exception exception)
    {
