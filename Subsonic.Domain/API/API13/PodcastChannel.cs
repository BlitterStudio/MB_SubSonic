...
public partial class PodcastChannel
{
    ...
    public static bool Deserialize(string input, out PodcastChannel obj, out Exception exception)
    {
        exception = null;
    ...
    public static PodcastChannel Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out PodcastChannel obj, out Exception exception)
    {
        exception = null;
        obj = default(PodcastChannel);
        try
    ...
    public static bool LoadFromFile(string fileName, out PodcastChannel obj, out Exception exception)
    {
