...
public partial class Shares
{
    ...
    public static bool Deserialize(string input, out Shares obj, out Exception exception)
    {
        exception = null;
        obj = default(Shares);
        try
    ...
    public static Shares Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out Shares obj, out Exception exception)
    {
        exception = null;
        obj = default(Shares);
        try
    ...
    public static bool LoadFromFile(string fileName, out Shares obj, out Exception exception)
    {
