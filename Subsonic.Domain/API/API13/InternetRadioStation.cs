...
public partial class InternetRadioStation
{
    ...
    public static InternetRadioStation Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out InternetRadioStation obj, out Exception exception)
    {
        exception = null;
        obj = default(InternetRadioStation);
        try
    ...
    public static bool LoadFromFile(string fileName, out InternetRadioStation obj, out Exception exception)
    {
