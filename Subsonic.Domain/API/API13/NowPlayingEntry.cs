...
public partial class NowPlayingEntry : Child
{
    ...
    public static bool Deserialize(string input, out NowPlayingEntry obj, out Exception exception)
    {
        exception = null;
    ...
    public static NowPlayingEntry Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out NowPlayingEntry obj, out Exception exception)
    {
        exception = null;
        obj = default(NowPlayingEntry);
        try
    ...
    public static bool LoadFromFile(string fileName, out NowPlayingEntry obj, out Exception exception)
    {
