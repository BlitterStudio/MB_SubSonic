...
public partial class Index
{
    ...
    public static bool Deserialize(string input, out Index obj, out Exception exception)
    {
        exception = null;
        obj = default(Index);
        try
    ...
    public static Index Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out Index obj, out Exception exception)
    {
        exception = null;
        obj = default(Index);
        try
