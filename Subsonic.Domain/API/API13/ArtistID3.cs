...
public partial class ArtistID3
{
    ...
    public static ArtistID3 Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out ArtistID3 obj, out Exception exception)
    {
        exception = null;
        obj = default(ArtistID3);
        try
    ...
    public static bool LoadFromFile(string fileName, out ArtistID3 obj, out Exception exception)
    {
