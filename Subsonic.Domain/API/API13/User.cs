...
public partial class User
{
    ...
    public static bool Deserialize(string input, out User obj, out Exception exception)
    {
        exception = null;
        obj = default(User);
        try
    ...
    public static User Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out User obj, out Exception exception)
    {
        exception = null;
        obj = default(User);
        try
    ...
    public static bool LoadFromFile(string fileName, out User obj, out Exception exception)
    {
