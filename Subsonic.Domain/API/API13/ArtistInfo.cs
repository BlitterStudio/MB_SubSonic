...
public partial class ArtistInfo : ArtistInfoBase
{
    ...
    public static ArtistInfo Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out ArtistInfo obj, out Exception exception)
    {
        exception = null;
        obj = default(ArtistInfo);
        try
    ...
    public static bool LoadFromFile(string fileName, out ArtistInfo obj, out Exception exception)
    {
