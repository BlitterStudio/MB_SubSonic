...
public partial class MusicFolder
{
    ...
    public static bool Deserialize(string input, out MusicFolder obj, out Exception exception)
    {
        exception = null;
    ...
    public static MusicFolder Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out MusicFolder obj, out Exception exception)
    {
        exception = null;
        obj = default(MusicFolder);
        try
    ...
    public static bool LoadFromFile(string fileName, out MusicFolder obj, out Exception exception)
    {
