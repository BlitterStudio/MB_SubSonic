...
public partial class Response
{
    ...
    public static Response Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out Response obj, out Exception exception)
    {
        exception = null;
        obj = default(Response);
        try
    ...
    public static bool LoadFromFile(string fileName, out Response obj, out Exception exception)
    {
