...
public partial class SearchResult2
{
    ...
    public static bool Deserialize(string input, out SearchResult2 obj, out Exception exception)
    {
        exception = null;
    ...
    public static SearchResult2 Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out SearchResult2 obj, out Exception exception)
    {
        exception = null;
        obj = default(SearchResult2);
        try
    ...
    public static bool LoadFromFile(string fileName, out SearchResult2 obj, out Exception exception)
    {
