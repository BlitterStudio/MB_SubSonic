...
public partial class Bookmarks
{
    ...
    public static bool Deserialize(string input, out Bookmarks obj, out Exception exception)
    {
        exception = null;
    ...
    public static Bookmarks Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out Bookmarks obj, out Exception exception)
    {
        exception = null;
        obj = default(Bookmarks);
        try
    ...
    public static bool LoadFromFile(string fileName, out Bookmarks obj, out Exception exception)
    {
