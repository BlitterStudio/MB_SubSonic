...
public partial class Lyrics
{
    ...
    public static bool Deserialize(string input, out Lyrics obj, out Exception exception)
    {
        exception = null;
        obj = default(Lyrics);
        try
    ...
    public static Lyrics Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out Lyrics obj, out Exception exception)
    {
        exception = null;
        obj = default(Lyrics);
        try
    ...
    public static bool LoadFromFile(string fileName, out Lyrics obj, out Exception exception)
    {
