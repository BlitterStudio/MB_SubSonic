...
public partial class AlbumWithSongsID3 : AlbumID3
{
    ...
    /// <summary>
    /// Serializes current AlbumWithSongsID3 object into an json string
    /// </summary>
    ...
    {
        return JsonConvert.DeserializeObject<AlbumWithSongsID3>(input);
    }
    #endregion
    ...
    public new static AlbumWithSongsID3 LoadFromFile(string fileName)
    {
