...
public partial class PodcastEpisode : Child
{
    ...
    /// <summary>
    /// Serializes current PodcastEpisode object into an json string
    /// </summary>
    ...
    {
        return JsonConvert.DeserializeObject<PodcastEpisode>(input);
    }
    #endregion
    ...
    public new static PodcastEpisode LoadFromFile(string fileName)
    {
