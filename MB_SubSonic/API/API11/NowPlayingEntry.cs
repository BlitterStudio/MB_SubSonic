...
public partial class NowPlayingEntry : Child
{
    ...
    /// <summary>
    /// Serializes current NowPlayingEntry object into an json string
    /// </summary>
    ...
    {
        return JsonConvert.DeserializeObject<NowPlayingEntry>(input);
    }
    #endregion
    ...
    public new static NowPlayingEntry LoadFromFile(string fileName)
    {
