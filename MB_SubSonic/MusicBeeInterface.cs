...
namespace MusicBeePlugin
{
    public partial class Plugin
    {
        ...
        public delegate bool Library_FindDevicePersistentIdDelegate(
            DeviceIdType idType, string[] ids, ref string[] values);
        ...
        public delegate bool Library_GetArtworkExDelegate(
            string sourceFileUrl, int index, bool retrievePictureData, ref PictureLocations pictureLocations,
            ref string pictureUrl, ref byte[] imageData);
        ...
        public delegate bool Library_GetFileTagsDelegate(
            string sourceFileUrl, MetaDataType[] fields, ref string[] results);
        ...
        public delegate bool Library_GetSyncDeltaDelegate(
            string[] cachedFiles, DateTime updatedSince, LibraryCategory categories, ref string[] newFiles,
            ref string[] updatedFiles, ref string[] deletedFiles);
        ...
        public delegate string Library_QuerySimilarArtistsDelegate(
            string artistName, double minimumArtistSimilarityRating);
        ...
        public delegate bool Library_SetDevicePersistentIdDelegate(
            string sourceFileUrl, DeviceIdType idType, string value);
        ...
        public delegate ToolStripItem MB_AddMenuItemDelegate(
            string menuPath, string hotkeyDescription, EventHandler handler);
        ...
        public delegate bool MB_AddTreeNodeDelegate(
            string treePath, string name, Bitmap icon, EventHandler openHandler, EventHandler closeHandler);
        ...
        public delegate bool MB_DownloadFileDelegate(
            string url, DownloadTarget target, string targetFolder, bool cancelDownload);
        ...
        public delegate bool MB_GetPluginViewInformationDelegate(
            string pluginFilename, out string[] viewNames, out string defaultViewName, out WindowState defaultState,
            out WindowState currentState);

        public delegate bool MB_GetVisualiserInformationDelegate(
            out string[] visualiserNames, out string defaultVisualiserName, out WindowState defaultState,
            out WindowState currentState);
        ...
        public delegate bool MB_OpenFilterInTabDelegate(
            MetaDataType field1, ComparisonType comparison1, string value1, MetaDataType field2,
            ComparisonType comparison2, string value2);
        ...
        public delegate int Player_OpenStreamHandleDelegate(
            string url, bool useMusicBeeSettings, bool enableDsp, ReplayGainMode gainType);
        ...
        public delegate bool Player_UpdatePlayStatisticsDelegate(
            string url, PlayStatisticType countType, bool disableScrobble);
        ...
        public delegate string Playlist_CreatePlaylistDelegate(
            string folderName, string playlistName, string[] filenames);
        ...
        public struct MusicBeeApiInterface
        {
            ...
            [Obsolete("Use NowPlayingList_QueryFilesEx", true)] public Library_QueryGetAllFilesDelegate
                NowPlayingList_QueryGetAllFiles;

            [Obsolete("Use Playlist_QueryFilesEx", true)] public Library_QueryGetAllFilesDelegate
